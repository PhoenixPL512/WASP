...
// The I2C register file is stored as an array of pointers, point these to
// whatever your I2C registers
// need to read/write in your code.  This abstracts the buffer and makes it
// easier to write directly
...
#define USI_SLAVE_COUNT_ACK_USISR                                              \
  0b01110000 | (0x0E << USICNT0) // Counts one clock (ACK)
#define USI_SLAVE_COUNT_BYTE_USISR                                             \
  0b01110000 | (0x00 << USICNT0) // Counts 8 clocks (BYTE)
#define USI_SLAVE_CLEAR_START_USISR                                            \
  0b11110000 | (0x00 << USICNT0) // Clears START flag
...
#define USI_SET_BOTH_OUTPUT()                                                  \
  { DDR_USI |= (1 << PORT_USI_SDA) | (1 << PORT_USI_SCL); }
#define USI_SET_BOTH_INPUT()                                                   \
  { DDR_USI &= ~((1 << PORT_USI_SDA) | (1 << PORT_USI_SCL)); }
