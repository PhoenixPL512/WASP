...
float LPS331::pressureToAltitudeMeters(float pressure_mbar,
...
float LPS331::pressureToAltitudeFeet(float pressure_inHg,
                                     float altimeter_setting_inHg) {
...
bool LPS331::testWhoAmI(void) { return (readReg(LPS331_WHO_AM_I) == 0xBB); }
